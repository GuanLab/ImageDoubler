...
# Other than the above four images, the rest of the images are split with the default parameters, for example:
# python split_image.py --image="Chip A Sample A (Left) Sample B (Right).jpg" --save="Image1"